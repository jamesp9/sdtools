...
set ruler
set runtimepath=~/.vim,~/.vim/bundle/syntastic,/var/lib/vim/addons,/usr/share/vim/vimfiles,/usr/share/vim/vim73,/usr/share/vim/vimfiles/after,/var/lib/vim/addons/after,~/.vim/after
set shiftwidth=4
set smarttab
set softtabstop=4
...
silent only
cd /srv/www/sdtools/polls
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +1 models.py
badd +1 ../sdtools/settings.py
badd +1 /srv/www/sdtools/sdtools/urls.py
badd +1 /srv/www/sdtools/sdtools/views.py
badd +3 /srv/www/sdtools/sdtools/templates/index.html
badd +1 admin.py
badd +9 /srv/www/sdtools/templates/admin/base_site.html
badd +1 views.py
badd +1 urls.py
badd +1 templates/polls/index.html
badd +1 templates/polls/detail.html
badd +0 templates/polls/results.html
args models.py
edit models.py
...
96
normal! 0
tabedit /srv/www/sdtools/sdtools/urls.py
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 32 - ((25 * winheight(0) + 21) / 43)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
32
...
15
normal! 0
tabedit /srv/www/sdtools/sdtools/views.py
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
9
normal! 029l
tabedit templates/polls/index.html
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
4
normal! 028l
tabedit templates/polls/detail.html
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
1
normal! 0
tabedit templates/polls/results.html
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
